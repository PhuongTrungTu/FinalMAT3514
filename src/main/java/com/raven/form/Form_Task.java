...
import com.raven.Service.Label;
import com.raven.Service.Major;
...
import com.raven.swing.table.EventAction1;
import java.awt.Color;
import javax.swing.Icon;

public class Form_Task extends javax.swing.JPanel {
    ...
    private void initTableData() {
        EventAction1 eventAction1 = new EventAction1() {
            @Override
            public void delete(Task task) {
                if (showMessage("Delete task : " + task.getTitle())) {
            ...
            public void update(Task task) {
                if (showMessage("Update task : " + task.getTitle())) {
                    System.out.println("User click OK");
                } else {
                    System.out.println("User click Cancel");
                }
        ...
        table1.addRow(new Task(new Title("Make a headliner"), new Date(10, 10, 2023), new Label("Front end"), new Major(), 30).toRowTable(eventAction1));
        table1.addRow(new Task(new Title("Make an input form"), new Date(10, 10, 2023), new Label("Front end"), new Major(), 30).toRowTable(eventAction1));
        table1.addRow(new Task(new Title("Link to the map API"), new Date(10, 10, 2023), new Label("Back end"), new Major(), 30).toRowTable(eventAction1));
    }
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Title", "Start Date", "End Date", "Status", "Major"
            }
        ) {
