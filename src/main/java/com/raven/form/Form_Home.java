...
import com.raven.Service.Date;
import com.raven.Service.Repository;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        EventAction eventAction = new EventAction() {
            ...
            public void delete(Project project) {
                if (showMessage("Delete project : " + project.getTittle())) {
            ...
            public void update(Project project) {
                ...
                if (showMessage("Update project : " + project.getTittle())) {
                    System.out.println("User click OK");
                    mainForm.showForm(new Form_Task());
                } else {
                    System.out.println("User click Cancel");
                }
            }
        ...
        // Tạo danh sách các dự án và thêm vào bảng
        projectList.add(new Project(new Title("Project Manager Application"), "20%", new Repository("Link"), new Date(21, 12, 2023)));
        projectList.add(new Project(new Title("Web Development Project"), "30%", new Repository("https://github.com/web-project"), new Date(20, 1, 2024)));
        projectList.add(new Project(new Title("Mobile App Development"), "10%", new Repository("https://github.com/mobile-app"), new Date(28, 2, 2024)));
        projectList.add(new Project(new Title("Database Optimization Project"), "50%", new Repository("https://github.com/db-optimization"), new Date(15, 1, 2024)));

        // Thêm dự án vào bảng
        for (Project project : projectList) {
            table1.addRow(project.toRowTable(eventAction));
        }
    ...
    private void initCardData() {
        ...
        card1.setData(new ModelCard("Progress Project 1", 20, icon1));
        Icon icon2 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.MONETIZATION_ON, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card2.setData(new ModelCard("Progress Project 2", 60, icon2));
        Icon icon3 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card3.setData(new ModelCard("Progress Project 3", 80, icon3));
    }
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Title", "Progress", "Repository", "Deadline", "Action"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34)
                        .addComponent(card2, javax.swing.GroupLayout.PREFERRED_SIZE, 326, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(32, 32, 32)
